                                ...
                                <form class="form" method="post" onsubmit="prevent(event)" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="employeeselect" name="khachhang">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <datalist id="browsers">
                                                <?php foreach ($data['products'] as $key => $value): ?>
                                                    <option value="<?php echo $value['MASP']."-".$value['TENSP']."-".$value['GIA']?>"><?php echo $value['MASP']."-".$value['TENSP']."-".$value['GIA']?></option>
                                                <?php endforeach;?>  
                                            </datalist>                                                                                        
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <script>                                        
                                                $(document).ready(function(){
                                                    ...
                                                    var masp = substrings[0];
                                                    var tensp = substrings[1];
                                                    ...
                                                    {                   
                                                        ...
                                                        var cell1 = row.insertCell(0).innerHTML = masp;
                                                        var cell2 = row.insertCell(1).innerHTML = tensp;
                                                    ...
                                                    {
                                                        alert("Số lượng sản phẩm không bị âm");
                                                    }                                      
                                                })                   
                                        })                                                                      
                                        </script>      
                                    ...
                                    <div class="form-actions center">                            
                                        <button type="submit" name="submit" class="btn btn-info" id="save">In hóa đơn</button>
                                        <script>
                                            $(document).ready(function(){
                                                $("#save").click(function(){
                                                    ...
                                                    for (var i = 1; i < rows.length; i++) {
                                                        ...
                                                        var masp = cells[0].innerHTML;
                                                        var tensp = cells[1].innerHTML;
                                                        var sl = cells[2].innerHTML;
                                                        var gia = cells[3].innerHTML;
                                                        data.push({masp: masp, tensp: tensp, sl: sl, gia: gia});
                                                    }
                                                    var dataset = JSON.stringify(data);
                                                    fetch(`http://localhost/adminmotoserv/index.php?controller=productbill&action=Test&time=${time}&customer=${customer}&employee=${employee}&total=${total}&data=${dataset}`)
                                        ...
                                        <a href="index.php?controller=productbill&action=update">
