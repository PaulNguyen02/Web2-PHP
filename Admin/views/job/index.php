<?php
    $urlDelete = "index.php?controller=job&action=delete&id=";
    $urlUpdate = "index.php?controller=job&action=update&id=";

    $urlIndex = "index.php?controller=job&action=index&page=";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title h3 primary text-center">Danh mục công viêc</h3>
              ...
              <div class="card-content collapse show">
                ...
                <a href="index.php?controller=job&action=insert" class="pl-1 float-left">
                <button type="button" class="btn btn-success btn-min-width mr-1 mb-1">
                <i class="la la-plus"></i> Thêm việc làm
                </button>
                </a>
                ...
                <div class="table-responsive px-1">
                  <table class="table">
                    ...
                    <?php if(empty($data['jobs'])):?>
                      <tr>
                        <td colspan="6" class="danger text-center">Không có công việc nào</td>
                      </tr>
                      <?php else :?>
                      <?php foreach($data['jobs'] AS $key => $value):?>
                        <tr>
                          <th scope="row"><?php echo $value['MACV'];?></th>
                          ...
                          <td>
                            <a href="<?php echo $urlDelete.$value['MACV'];?>" data-toggle="tooltip" data-placement="top" title="Xóa công việc" onclick="return confirm('Bạn có chắc muốn công việc này?')">
