          ...
          <div class="col-xl-4 col-lg-6 col-md-12" style="position:relative;">
                  <div class="card pull-up ecom-card-1 bg-white">
                      <div class="card-content ecom-card2 height-180">
                          <h5 class="text-muted danger position-absolute p-1 display-4"><?php echo $data['accounts'];?></h5>
                          <div>
                              <i class="la la-user danger font-large-4 float-right p-1"></i>
                          </div>
                          
                          <h4 class="text-muted danger position-absolute pl-1" style="top:90px;">Tài khoản</h4>
              ...
              <div class="col-xl-4 col-lg-6 col-md-12">
                ...
                <div class="card pull-up ecom-card-1 bg-white">
                    <div class="card-content ecom-card2 height-180">
                        <h5 class="text-muted info position-absolute p-1 display-4"><?php echo $data['fixservices']?></h5>
                        <div>
                            <i class="la la-cube info font-large-4 float-right p-1"></i>
                        </div>
                        <h4 class="text-muted info position-absolute pl-1" style="top:90px;">Dịch vụ</h4>
                          
                          <div class="text-muted position-absolute" style="bottom:5px;left:35%;">
                          <span class="">
                            <a href="index.php?controller=fixservice&action=index&page=1" class="card-link">Xem chi tiết
                              <i class="la la-angle-right" style="font-size:1rem;"></i>
                            </a>
                          </span>
                        </div>
              ...
              <div class="col-xl-4 col-lg-12">
                <div class="card pull-up ecom-card-1 bg-white">
                    <div class="card-content ecom-card2 height-180">
                        <h5 class="text-muted warning position-absolute p-1 display-4"><?php echo $data['productbills'];?></h5>
                        <div>
                            <i class="la la-list-alt warning font-large-4 float-right p-1"></i>
                        </div>
                        <h4 class="text-muted warning position-absolute pl-1" style="top:90px;">Hóa đơn sản phẩm</h4>
                          
                          <div class="text-muted position-absolute" style="bottom:5px;left:35%;">
                          <span class="">
                            <a href="index.php?controller=productbill&action=index&page=1" class="card-link">Xem chi tiết
                              <i class="la la-angle-right" style="font-size:1rem;"></i>
                            </a>
                          </span>
                        </div>
            ...
            <div class="col-xl-4 col-lg-12">
                <div class="card pull-up ecom-card-1 bg-white">
                    <div class="card-content ecom-card2 height-180">
                        <h5 class="text-muted warning position-absolute p-1 display-4"><?php echo $data['fixservices'];?></h5>
                        <div>
                            <i class="la la-list-alt warning font-large-4 float-right p-1"></i>
                        </div>
                        <h4 class="text-muted warning position-absolute pl-1" style="top:90px;">Hóa đơn dịch vụ</h4>
              ...
              <div class="col-xl-4 col-lg-12">
                <div class="card pull-up ecom-card-1 bg-white">
                    <div class="card-content ecom-card2 height-180">
                        <h5 class="text-muted success position-absolute p-1 display-4"><?php echo $data['jobs'];?></h5>
                        <div>
                            <i class="la la-key success font-large-4 float-right p-1"></i>
                        </div>
                        <h4 class="text-muted success position-absolute pl-1" style="top:90px;">Việc làm</h4>
                          
                          <div class="text-muted position-absolute" style="bottom:5px;left:35%;">
                          <span class="">
                            <a href="index.php?controller=job&action=index&page=1" class="card-link">Xem chi tiết
                              <i class="la la-angle-right" style="font-size:1rem;"></i>
                            </a>
                          </span>
                        </div>
              ...
              <div class="col-xl-4 col-lg-12">
                <div class="card pull-up ecom-card-1 bg-white">
                    <div class="card-content ecom-card2 height-180">
                        <h5 class="text-muted success position-absolute p-1 display-4"><?php echo $data['recruitments'];?></h5>
                        <div>
                            <i class="la la-key success font-large-4 float-right p-1"></i>
                        </div>
                        <h4 class="text-muted success position-absolute pl-1" style="top:90px;">Ứng cử viên</h4>
                          
                          <div class="text-muted position-absolute" style="bottom:5px;left:35%;">
                          <span class="">
                            <a href="index.php?controller=precruitment&action=index&page=1" class="card-link">Xem chi tiết
                              <i class="la la-angle-right" style="font-size:1rem;"></i>
                            </a>
                          </span>
                        </div>
              ...
              <div class="card pull-up ecom-card-1 bg-white">
                    <div class="card-content ecom-card2 height-180">
                        <h5 class="text-muted primary position-absolute p-1 display-4"><?php echo $data['bookings'];?></h5>
                        <div>
                            <i class="fa fa-list-alt primary font-large-4 float-right p-1"></i>
                        </div>
                        <h4 class="text-muted primary position-absolute pl-1" style="top:90px;">Lịch đặt</h4>
                          
                          <div class="text-muted position-absolute" style="bottom:5px;left:35%;">
                          <span class="">
                            <a href="index.php?controller=booking&action=index&page=1" class="card-link">Xem chi tiết
                              <i class="la la-angle-right" style="font-size:1rem;"></i>
                            </a>
                          </span>
                        </div>
