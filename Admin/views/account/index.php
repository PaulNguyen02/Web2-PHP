          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title secondary h3 text-center">Quản lý tài khoản</h3>
                  ...
                  <table class="table">
                    ...
                    <?php if(empty($data['accounts'])):?>
                      ...
                      <?php foreach($data['accounts'] AS $key => $value):?>
                        <tr>
                          <td scope="row"><?php echo $value['UID'];?></td> 
                          ...
                          <td>
                            <a href="<?php echo $urlUpdate.$value['UID'];?>" data-toggle="tooltip" data-placement="top" title="Sửa tài khoản">
                                  <i class="la la-edit warning font-large-1" ></i>
                            </a>
                            <a href="<?php echo $urlDelete.$value['UID'];?>" data-toggle="tooltip" data-placement="top" title="Xóa tài khoản" onclick="return confirm('Bạn có chắc muốn xóa tài khoản này?')">
